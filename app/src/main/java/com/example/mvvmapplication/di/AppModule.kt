...
import com.example.mvvmapplication.persistence.AppDatabase
import com.example.mvvmapplication.persistence.AppDatabase.Companion.DATABASE_NAME
...
class AppModule{
    ...
    fun provideGsonBuilder(): Gson{
        //ignore all the fields that dont have @Expose annotation when getting response from retrofit call
